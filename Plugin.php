    ...
    public function form(): array
    {
        return [
            'gateway_url' => [
                ...
                'type' => 'string',
                'required' => true,
                'description' => 'BEpusdt domain, for example: https://pay.example.com',
            ],
            'api_token' => [
                'label' => 'API Token',
                'type' => 'string',
                'required' => true,
                'description' => 'Token from BEpusdt admin panel',
            ],
            'mode' => [
                'label' => 'Mode',
                'type' => 'string',
                'default' => self::CASHIER_MODE,
                'description' => 'cashier or transaction',
            ],
            'fiat' => [
                'label' => 'Fiat',
                'type' => 'string',
                'default' => 'CNY',
                'description' => 'Default fiat currency, such as CNY or USD',
            ],
            'product_name' => [
                'label' => 'Product Name',
                'type' => 'string',
                'description' => 'Optional title shown in BEpusdt cashier',
            ],
            'timeout' => [
                'label' => 'Timeout Seconds',
                'type' => 'number',
                'description' => 'cashier mode min 180, transaction mode min 120',
            ],
            'currencies' => [
                'label' => 'Cashier Currencies',
                'type' => 'string',
                'description' => 'Used in cashier mode, for example: USDT,USDC or -ETH,-BNB',
            ],
            'trade_type' => [
                'label' => 'Trade Type',
                'type' => 'string',
                'default' => 'usdt.trc20',
                'description' => 'Used in transaction mode, for example: usdt.trc20',
            ],
            'address' => [
                'label' => 'Fixed Address',
                'type' => 'string',
                'description' => 'Optional fixed receive address for transaction mode',
            ],
            'rate' => [
                'label' => 'Rate Rule',
                'type' => 'string',
                'description' => 'Optional custom rate rule, for example: ~1.02 or +0.3',
            ],
        ];
    }
